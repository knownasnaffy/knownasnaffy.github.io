        ...
        <p>
          <ul>
            <li className="flex items-start">
              ...
              <span>
                <i className="underline underline-offset-2">Selected</i> for the college{' '}
                <i className="underline underline-offset-2">ERP development</i> team in the first
                semester.
              </span>
            </li>
            <li className="flex items-start">
              <span className="mr-3.5 ml-1 text-[#4A5565]">•</span>
              <span>
                Secured <i className="underline underline-offset-2">2nd place</i> in an internal
                college <i className="underline underline-offset-2">hackathon</i> (Oct 2024).
              </span>
            </li>
            <li className="flex items-start">
              <span className="mr-3.5 ml-1 text-[#4A5565]">•</span>
              <span>
                Co-coordinated the Science Day celebration event (Mar 2025), managing planning and
                logistics with a peer.
              </span>
            </li>
          </ul>
        </p>
